...
import com.asteroidbelt.effects.influencers.AsteroidInfluencer;
import com.asteroidbelt.effects.shapes.DiscEmitterShape;
import com.asteroidbelt.jmeplanet.FractalDataSource;
import com.asteroidbelt.jmeplanet.Planet;
import com.asteroidbelt.jmeplanet.Utility;
...
public class AsteroidsAppState extends SimpleApplication {
    ...
    public void initialize(AppStateManager stateManager, Application app) {
        ...
        */
        ...
        this.stars = new Node();
        this.app.getRootNode().attachChild(this.stars);
        ...
        this.app.getRootNode().addLight(this.light);
        createMoon(0);
        createSkybox();
        setupEmitters();
        createLensFlare();
    ...
    private void setupEmitters() {
        Node particleNode = (Node) this.app.getAssetManager().loadModel("Models/DustEmitter.j3o");
        ...
        this.particleEmitter3.setQueueBucket(Bucket.Sky);
        ...
        this.app.getRootNode().attachChild(this.particleEmitter);
        this.app.getRootNode().attachChild(this.particleEmitter2);
        this.app.getRootNode().attachChild(this.particleEmitter3);
    }
    ...
    private void updateMoon(float tpf) {
        ...
        if (distFactor < 0.01f) {
            ...
            this.moon.setCameraPosition(this.app.getCamera().getLocation());
        }
    }

    private void initPeripheralAsteroids() {
        this.mat = this.app.getAssetManager().loadMaterial("Materials/Generated/asteroid1-Icosphere1.j3m");
    ...
    private Geometry createAsteroid(int x, int y, int z, int zMultiplier) {
        Geometry star = ((Geometry) this.asteroidModels.get(FastMath.nextRandomInt(0, 3))).clone();
    ...
    private Spatial createMoon(long seed) {
        ...
        this.moon = Utility.createMoonLikePlanet(this.app.getAssetManager(), 25.0f, moonDataSource);
        this.app.getRootNode().attachChild(this.moon);
        this.moon.setLocalTranslation(40.0f, 15.0f, (-this.moonMaxDistance) * 0.65f);
        return this.moon;
    }

    private void createSkybox() {
        this.app.getRootNode().attachChild(SkyFactory.createSky(this.app.getAssetManager(), this.app.getAssetManager().loadTexture("Textures/skybox/skybox_left2.png"), this.app.getAssetManager().loadTexture("Textures/skybox/skybox_right1.png"), this.app.getAssetManager().loadTexture("Textures/skybox/skybox_front5.png"), this.app.getAssetManager().loadTexture("Textures/skybox/skybox_back6.png"), this.app.getAssetManager().loadTexture("Textures/skybox/skybox_top3.png"), this.app.getAssetManager().loadTexture("Textures/skybox/skybox_bottom4.png"), new Vector3f(10.0f, 10.0f, 10.0f)));
    }

    private void createLensFlare() {
        Geometry flare = new Geometry("Flare", new Quad(150.0f, 75.0f));
        flare.move(-140.0f, -32.0f, 75.0f);
        flare.setQueueBucket(Bucket.Transparent);
        ...
        mat.setTexture("ColorMap", this.app.getAssetManager().loadTexture("Textures/lens_flare.png"));
        mat.getAdditionalRenderState().setDepthTest(true);
        mat.getAdditionalRenderState().setDepthWrite(true);
        mat.getAdditionalRenderState().setBlendMode(BlendMode.AlphaAdditive);
        flare.setMaterial(mat);
        this.app.getRootNode().attachChild(flare);
    }
