...
import com.example.rudz.jme_test.R;
 ...
 */
public class CubeFieldActivity extends AndroidGvrHarness implements GvrView.StereoRenderer {

  private static final String TAG = "CubeFieldActivity";
  ...
  public CubeFieldActivity() {
    ...
    appClass = CubeField.class.getCanonicalName();
  }
